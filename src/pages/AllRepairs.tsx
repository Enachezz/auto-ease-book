...
import { ArrowLeft, Search, Wrench, Disc, Settings, Zap, Circle, Truck, Cog, Thermometer, Hammer, SearchIcon, Car, Battery, Wind, Hammer as HammerIcon, Shield, Key, Move, Gauge, Eye, Hammer as ToolIcon, HelpCircle, Stethoscope } from 'lucide-react';
...
const AllRepairs = () => {
  ...
  const handleCategorySelect = (categoryName: string) => {
    // Navigate back to request service with the selected category
    ...
    <Layout>
      <div className="max-w-4xl mx-auto space-y-6 p-4 md:p-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold">Toate Reparațiile</h1>
